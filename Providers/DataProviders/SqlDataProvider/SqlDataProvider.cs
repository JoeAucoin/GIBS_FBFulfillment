...
namespace GIBS.Modules.GIBS_FBFulfillment.Data
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "GIBS_FBFulfillment_";
        ...
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "GetOrderDetails", visitID);
        }
